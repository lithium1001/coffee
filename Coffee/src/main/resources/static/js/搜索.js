...
var backendUrls = ['http://47.115.230.54:8080/CoffeeVerse/articles', 'http://47.115.230.54:8080/post/list','http://47.115.230.54:8080/coffee-shop/shoplist'];
        ...
        backendUrls.forEach(function(url) {
            ...
            $.ajax({
                ...
                success: function(jsonData) {
                    var fieldValues;
                    if (url === 'http://47.115.230.54:8080/coffee-shop/shoplist') {
